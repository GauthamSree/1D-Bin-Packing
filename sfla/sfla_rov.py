...
from utils.binpackingsolution_rov import BinPackingSolutions
from utils.binpackingsolution_rov import BinDetails
...
class SFLA:
    ...
    def new_step(self, best_frog: BinDetails, worst_frog: BinDetails):
        ...
        new_frog = self.bins_data.first_fit_alogrithm(new_rov_continous)
        return new_frog
...
if __name__ == "__main__":
    ...
    sfla = SFLA(frogs=480, mplx_no=40, no_of_iteration=n, no_of_mutation=12, q=8)
    sfla.run_sfla(path)